void LEDsUtility(){//----CH4 & CH5 (6)----

//----Change Memory Address!----
	uint8_t BrightnessMem = EEPROM.read(MemoryAddressUti);
//----Change Memory Address!----
...
//-----Brightness Level----------------------------------------
	...
	// Constant
		// Under
		//LEDs_Under(LEDs_Under_1G1S, LEDs_Under_1G1E).fill_solid(ColorBlack);
		// Front
	...
	// Pulse 1
		...
		LEDs_Rear(LEDs_Rear_5G1S, LEDs_Rear_5G1E).fill_solid(ColorOrange);
		LEDs_Rear(LEDs_Rear_5G3S, LEDs_Rear_5G3E).fill_solid(ColorOrange);
		LEDs_Rear(LEDs_Rear_5G5S, LEDs_Rear_5G5E).fill_solid(ColorOrange);
		// Display
		FastLED.show();
	...
	// Pulse 2
		...
		LEDs_Under(LEDs_Under_5G2S, LEDs_Under_5G2E).fill_solid(ColorWhite);
		LEDs_Under(LEDs_Under_5G4S, LEDs_Under_5G4E).fill_solid(ColorWhite);
		LEDs_Under(LEDs_Under_5G6S, LEDs_Under_5G6E).fill_solid(ColorWhite);
		// Front
		...
		LEDs_Grill(LEDs_Grill_6G1S, LEDs_Grill_6G1E).fill_solid(ColorWhite);
		LEDs_Grill(LEDs_Grill_6G6S, LEDs_Grill_6G6E).fill_solid(ColorWhite);
		// Rear
		...
		LEDs_Rear(LEDs_Rear_5G2S, LEDs_Rear_5G2E).fill_solid(ColorRed);
		LEDs_Rear(LEDs_Rear_5G4S, LEDs_Rear_5G4E).fill_solid(ColorRed);
		// Display
		FastLED.show();
		FastLED.delay(Strobe);
	// Pulse 2
	
	//Serial.println("Pattern: Utility");
}//----CH4 & CH5 (6)----